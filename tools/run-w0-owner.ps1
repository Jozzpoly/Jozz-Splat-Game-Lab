...
try {
    ...
    Write-Host 'To jest test kalibracji skali metrycznej. Nie wymaga npm ani terminala.'
    Write-Host ''
    ...
    Write-Host ''
    Write-Host 'W0.3: FAIL'
    Write-Host $_.Exception.Message
    Show-ErrorBox ("W0.3: FAIL`n`n" + $_.Exception.Message + "`n`nNie naprawiaj tego sam. Wyslij mi screenshot komunikatu.")
    exit 1
}
finally {
