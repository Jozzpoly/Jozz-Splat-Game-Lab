...
Turn real captures into physically coherent, open-ended worlds that are enjoyable to inhabit and experiment with. The first game hypothesis is still a tiny physics sandbox with only a few conventional dynamic objects; it remains unproven until G0 owner playtesting.
